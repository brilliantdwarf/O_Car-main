...
libraries/infineon_libraries/iLLD/TC26B/Tricore/Psi5s/Std/%.src: ../libraries/infineon_libraries/iLLD/TC26B/Tricore/Psi5s/Std/%.c libraries/infineon_libraries/iLLD/TC26B/Tricore/Psi5s/Std/subdir.mk
	...
	cctc -D__CPU__=tc26xb "-fD:/AURIX-Studio-1.5.4/Workspace/O_Car-main/O_Car-main/E05_03_imu660ra_demo/Debug/TASKING_C_C___Compiler-Include_paths.opt" --iso=99 --c++14 --language=+volatile --exceptions --anachronisms --fp-model=3 -O0 --tradeoff=4 --compact-max-size=200 -g -Wc-w544 -Wc-w557 -Ctc26xb -o "$@"  "$<"  -cs --dep-file="$(@:.src=.d)" --misrac-version=2012 -N0 -Z0 -Y0 2>&1;
